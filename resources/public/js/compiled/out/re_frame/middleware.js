...
if(!((function (){var G__25719 = app_db;
if(G__25719){
...
return G__25719.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__25719.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__25719);
} else {
return false;
}
}
...
re_frame$middleware$path.cljs$lang$applyTo = (function (arglist__25725){
...
return cljs.core.get_in.call(null,new_db,p1__25726_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__25727_SHARP_){
return cljs.core.get_in.call(null,db,p1__25727_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
while (G__25728__i < G__25728__a.length) {G__25728__a[G__25728__i] = arguments[G__25728__i + 2]; ++G__25728__i;}
  in_paths = new cljs.core.IndexedSeq(G__25728__a,0);
} 
...
re_frame$middleware$on_changes.cljs$lang$applyTo = (function (arglist__25729){
var f = cljs.core.first(arglist__25729);
arglist__25729 = cljs.core.next(arglist__25729);
var out_path = cljs.core.first(arglist__25729);
var in_paths = cljs.core.rest(arglist__25729);
...
//# sourceMappingURL=middleware.js.map?rel=1434750193523
...
var or__18174__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18174__auto__)){
return or__18174__auto__;
} else {
var or__18174__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18174__auto____$1)){
return or__18174__auto____$1;
} else {
var or__18174__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18174__auto____$2)){
return or__18174__auto____$2;
} else {
var or__18174__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18174__auto____$3)){
return or__18174__auto____$3;
} else {
...
var n__19059__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19059__auto__)){
var c_25374 = (a[i]);
if(cljs.core.truth_((c_25374["cljsIsDirty"]))){
(c_25374["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__18753__auto__,writer__18754__auto__,opt__18755__auto__){
return cljs.core._write.call(null,writer__18754__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__25378 = c;
var G__25378__$1 = (((G__25378 == null))?null:(G__25378["props"]));
var G__25378__$2 = (((G__25378__$1 == null))?null:(G__25378__$1["argv"]));
return G__25378__$2;
});
...
var G__25380_25381 = (c["cljsRatom"]);
var G__25380_25382__$1 = (((G__25380_25381 == null))?null:reagent.ratom.dispose_BANG_.call(null,G__25380_25381));

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1434750192874